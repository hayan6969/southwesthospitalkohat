...
import { Users, UserCheck, Calendar, DollarSign, Shield, Activity } from "lucide-react";
  ...
  return (
    <AppLayout>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foregroun">Neurologist</p>
                </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div>
          <AuditLog events={auditLogs?.slice(0, 5).map(log => ({
