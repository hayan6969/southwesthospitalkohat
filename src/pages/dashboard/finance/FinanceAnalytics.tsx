      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={[
                { name: 'Without Pharmacy', value: hospitalProfitWithoutPharmacy },
                { name: 'Pharmacy Profit', value: pharmacyProfit },
                { name: 'With Pharmacy', value: hospitalProfitWithPharmacy }
              ]}>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <h4 className="font-semibold text-sm text-muted-foreground">Pharmacy Performance</h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span>Sales:</span>
                  <span className="font-medium">{formatPkrAmount(pharmacySales)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Profit:</span>
                ...
                <div className="flex justify-between">
                  <span>Margin:</span>
                  <span className="font-medium">{pharmacySales > 0 ? ((pharmacyProfit / pharmacySales) * 100).toFixed(1) : '0'}%</span>
                </div>
              </div>
            </div>
            <div className="space-y-2">
              <h4 className="font-semibold text-sm text-muted-foreground">Hospital Revenue Sources</h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span>Emergency:</span>
                  <span className="font-medium">{formatPkrAmount(emergencyRevenue)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Operations:</span>
                  <span className="font-medium">{formatPkrAmount(operationsRevenue)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Lab:</span>
                ...
                <div className="flex justify-between">
                  <span>X-ray:</span>
                  <span className="font-medium">{formatPkrAmount(xrayRevenue)}</span>
                </div>
              </div>
            </div>
            <div className="space-y-2">
              <h4 className="font-semibold text-sm text-muted-foreground">Profit Analysis</h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span>Hospital Only:</span>
                  <span className={`font-medium ${hospitalProfitWithoutPharmacy >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                    {formatPkrAmount(hospitalProfitWithoutPharmacy)}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between border-t pt-1">
                  ...
                  <span className={`font-bold ${hospitalProfitWithPharmacy >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                    {formatPkrAmount(hospitalProfitWithPharmacy)}
                  </span>
                </div>
              </div>
