...
export function PostAdmissionEntry({ open, onOpenChange, admission, patientName }: Props) {
  ...
  const printForm = () => {
    const html = document.getElementById("post-admission-print-content")?.outerHTML || "";
    ...
    <style>
      ...
      .section-title { font-weight: bold; font-size: 12px; text-align: center; padding: 5px; border: 1px solid #000; }
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto z-[9999]">
        <DialogHeader className="flex-row items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="outline" size="sm" onClick={printForm}><Printer className="w-4 h-4 mr-1" />Print Form</Button>
