  ...
  return useMutation({
    mutationFn: async (patientData: {
      ...
      try {
        ...
        const { data: accountResult, error: accountError } = await (supabase as any).rpc('create_patient_account', {
          p_phone: phone,
        ...
        }) as { data: { user_id?: string; patient_number?: string; phone?: string } | null; error: { message?: string; code?: string } | null };
...
export const useCreateMedicine = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['medicines-searchable'] });
