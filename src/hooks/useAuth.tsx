...
type UserProfile = {
  ...
  last_name: string;
  phone?: string;
  role: 'admin' | 'doctor' | 'staff' | 'ota' | 'head_pharmacist' | 'assistant_pharmacist' | 'salesman_pharmacist' | 'patient' | 'finance' | 'nursing' | 'inventory_manager' | 'store' | 'lab';
    ...
    try {
      ...
      if (data) {
        ...
        const profile: UserProfile = {
          ...data,
          role: data.role as 'admin' | 'doctor' | 'staff' | 'ota' | 'head_pharmacist' | 'assistant_pharmacist' | 'salesman_pharmacist' | 'patient' | 'finance' | 'nursing' | 'inventory_manager' | 'store' | 'lab'
        };
...
export const useAuth = () => {
  ...
  if (context === undefined) {
    ...
    // instead of throwing, which causes a blank screen
    return {
      user: null,
      profile: null,
      session: null,
